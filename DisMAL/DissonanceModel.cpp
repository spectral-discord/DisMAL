...
CBRModel::CBRModel()
{
    name = "Critical Band Roughness Model Base";
}
...
float CBRModel::calculateDissonance (const OwnedArray<OvertoneDistribution>& distributions,
...
std::unique_ptr<DissonanceModel> SetharesModel::cloneModel()
{
...
std::unique_ptr<DissonanceModel> VassilakisModel::cloneModel()
{

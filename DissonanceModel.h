...
public:
    ...
    virtual std::unique_ptr<DissonanceModel> cloneModel() = 0;
...
*/
class CBRModel :   public DissonanceModel
{
public:
...
/** Implementation of Sethares' model from "Tuning, Timbre, Spectrum, Scale" (2005).
    ...
    \f$$f_1 < f_2$\f$
*/
class SetharesModel :   public CBRModel
{
public:
    ...
    std::unique_ptr<DissonanceModel> cloneModel() override;
...
/** Implementation of Vassilakis' model from "Perceptual and Physical Properties of Amplitude Fluctuation and their Musical Significance" (2001).
    ...
    \f$$f_1 < f_2$\f$
*/
class VassilakisModel :   public CBRModel
{
public:
